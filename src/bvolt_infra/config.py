...
grafana_dashboard_uid = os.getenv("GRAFANA_DASHBOARD_UID", "adxmk4pdbvolt")
grafana_dashboard_slug = os.getenv("GRAFANA_DASHBOARD_SLUG", "bvolt").strip("/")
grafana_dashboard_title = os.getenv("GRAFANA_DASHBOARD_TITLE", "bvolt")
